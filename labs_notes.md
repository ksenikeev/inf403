...
## 12.03.2025
Реализация списка Integer по описанию в интерфейсе
Задание:
1) Класс List403Impl
2) Реализовать сортировку (по возрастанию, по убыванию)
3) Реализовать тесты всех методов
...
Задание
1) Реализовать двунаправленный (двусвязный) список (Node{ value, next, prev})
2) value - класс с несколькими атрибутами
3) сделать интерфейс CanCompare { compare() } описывающий сравнение двух объектов
4) value должен реализовывать этот интерфейс
5) реализовать сортировку пузырьком в которой для сравнения вызывать compare
